      ...
      <header className="bg-white sticky top-0 z-30 border-b border-stone-200 shadow-xs">
        <div className="max-w-2xl mx-auto px-3 sm:px-4 py-2.5 flex items-center justify-between gap-2">
          ...
          <button
            ...
            className="bg-emerald-800 hover:bg-emerald-900 active:scale-95 text-white px-3 py-1.5 rounded-xl text-xs font-bold flex items-center gap-1 transition cursor-pointer shrink-0 shadow-xs"
          >
            <span>📲</span>
